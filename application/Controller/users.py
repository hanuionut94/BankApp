...
class UsersController:
    ...
    def create_user(self, user_id, first_name, last_name, email, address, phone_number, date_of_birth, join_date):
        self.create_user(user_id, first_name, last_name, email, address, phone_number, date_of_birth, join_date)
