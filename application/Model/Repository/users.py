from application.Model.Domain.users import Users
...
if __name__ == '__main__':
    ...
    user_repo.add_user(1234232, 'Popescu', 'Eusebiu', 'popescu.eusebiu', 'Braila', 751115123, '1998-09-01', join_date=date.today())